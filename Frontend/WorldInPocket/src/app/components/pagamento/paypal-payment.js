...
const clientId = 'ARAvkmld2iyJq2Kuw9cCN6yg84JCuCe92BhlubB4TEsy0yMGjvsciKLgYGgr4fxq8e0WSpap0V-Cfj8X';
const clientSecretKey = 'EJI86n-2WFONwhO2OMgMED0EvpbSd5JQl9SNVsWa9HHqRwgvtdEGHOXibuRNYKUdjff6D2Aj-iHvWYLc';

const environment = new paypal.core.LiveEnvironment(clientId, clientSecretKey);
...
async function processPayment(orderId, amount) {
  ...
  request.requestBody({
    payer_id: 'YOUR_PAYER_ID'
  });


  request.requestBody().amount.value = amount;
  request.requestBody().amount.currency_code = 'EUR';
...
const get_client_token = () => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await fetch("http://localhost:4200/get_client_token", {
...
const client_id = "ARAvkmld2iyJq2Kuw9cCN6yg84JCuCe92BhlubB4TEsy0yMGjvsciKLgYGgr4fxq8e0WSpap0V-Cfj8X";
const currency = "EUR";
...
.then(() => {
    ...
    let paypal_buttons = paypal.Buttons({ // https://developer.paypal.com/sdk/js/reference
        ...
        createOrder: function(data, actions) { //https://developer.paypal.com/docs/api/orders/v2/#orders_create
            return fetch("http://localhost:4200/create_order", {
        ...
        onApprove: function(data, actions) {
            ...
            console.log(data);
            return fetch("http://localhost:4200/complete_order", {
                method: "post", headers: { "Content-Type": "application/json; charset=utf-8" },
                body: JSON.stringify({
                    "intent": intent,
                    "order_id": order_id
